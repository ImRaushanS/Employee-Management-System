# -*- coding: utf-8 -*-
"""
Created on Sat Jun  4 02:43:12 2022
...
class Employee:
    def __init__(self,root):
        ...
        img_logo=Image.open('C:/Users/RAUSAN/Downloads/project_leader.jpg')
        ...
        img1=Image.open('empimage1.png')
        img1.resize((450,160),Image.ANTIALIAS)
        ...
        img6=Image.open('empimage6.png')
        img6.resize((450,160),Image.ANTIALIAS)
        self.photo6=ImageTk.PhotoImage(img6)
        
        self.img_6=Label(img_frame,image=self.photo6)
        self.img_6.place(x=450,y=0,width=450,height=160)
        
        
        img7=Image.open('empimage7.png')
        img7.resize((450,160),Image.ANTIALIAS)
        self.photo7=ImageTk.PhotoImage(img7)
        
        self.img_7=Label(img_frame,image=self.photo7)
        self.img_7.place(x=900,y=0,width=450,height=160)
        
        
        
        Main_frame=Frame(self.root,bd=2,relief=RIDGE,bg='white')
        Main_frame.place(x=10,y=220,width=1335,height=560)
        ...
        upper_frame.place(x=10,y=10,width=1310,height=270)
        ...
        com_txt_proof['value']=('Select ID Proof','PAN CARD','DRIVING LICEIENCE','ADHAR CARD')
        ...
        #mask image
        img_mask=Image.open('C:/Users/RAUSAN/Downloads/empimage/mask1.jpg')
       # img_mask.resize((120,120),Image.ANTIALIAS)
        self.photo_mask=ImageTk.PhotoImage(img_mask)
        
        self.img_mask=Label(upper_frame,image=self.photo_mask)
        self.img_mask.place(x=990,y=0,width=160,height=220)
        
        
        #SQLBuuton Frame
        button_frame=Frame(upper_frame,bd=2,relief=RIDGE,bg='white')
        button_frame.place(x=1160,y=10,width=140,height=210)
        
        btn_add=Button(button_frame,text='Save',command=self.add_data,font=('arial',15,'bold'),width=11,bg='blue',fg='white')
        btn_add.grid(row=0,column=0,padx=1,pady=5)
        
        btn_update=Button(button_frame,text='Update',font=('arial',15,'bold'),width=11,bg='blue',fg='white')
        btn_update.grid(row=1,column=0,padx=1,pady=5)
        
        btn_delete=Button(button_frame,text='Delete',font=('arial',15,'bold'),width=11,bg='blue',fg='white')
        btn_delete.grid(row=2,column=0,padx=1,pady=5)
        
        btn_clear=Button(button_frame,text='Clear',font=('arial',15,'bold'),width=11,bg='blue',fg='white')
        ...
        down_frame.place(x=10,y=280,width=1310,height=270)
        ...
        search_frame.place(x=0,y=0,width=1300,height=50)
        
        search_by=Label(search_frame,font=('arial',10,'bold'),text="Search By:",fg='white',bg='red')
        search_by.grid(row=0,column=0,padx=5,sticky=W)
        
        #Search
        com_txt_search=ttk.Combobox(search_frame,font=('arial',10,'bold'),width=17,state='readonly')
        ...
        btn_search=Button(search_frame,text='Search',font=('arial',10,'bold'),width=12,bg='blue',fg='white')
        btn_search.grid(row=0,column=3,padx=5)
        
        btn_ShowAll=Button(search_frame,text='Show All',font=('arial',10,'bold'),width=12,bg='blue',fg='white')
        btn_ShowAll.grid(row=0,column=4,padx=5)
        
        stayhome=Label(search_frame,font=('times new roman',28,'bold'),text="Wear a Mask",bg='white',fg='red')
        stayhome.place(x=750,y=0,width=550,height=28)
        
        img_logo_mask=Image.open('C:/Users/RAUSAN/Downloads/empimage/mask1.jpg')
        ...
        self.logo.place(x=850,y=0,width=50,height=30)
       
        
        #Employee Table
        table_frame=Frame(down_frame,bd=3,relief=RIDGE)
        table_frame.place(x=0,y=50,width=1300,height=130)
    ...
    def add_data(self):
        if self.var_dep.get()=='' or self.var_email.get()=='':
            ...
            try:
                conn=mysql.connector.Connect(host='localhost',username='root',password='Sharma@123',database='mydata')
